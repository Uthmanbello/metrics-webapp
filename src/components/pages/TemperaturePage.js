...
function TemperaturePage() {
    ...
    return (
      ...
      <ul>
      <li className="even1 list first"><span>Max temp</span> <span>{data.main.temp_max} K</span></li>
      <li className="list"><span>Min temp</span> {data.main.temp_min} K</li>
      <li className="even1 list"><span>Current temp</span> {data.main.temp} K</li>
